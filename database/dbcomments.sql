...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-07-2021 a las 02:36:55
...
INSERT INTO `comments` (`id_comment`, `id_new_fk`, `author`, `comment`, `score`) VALUES
(7, 45, 'admin', 'Buena nota', 2),
(8, 45, 'admin', 'Notaloko', 4),
(10, 43, 'admin', 'Buenardopolis', 5),
(11, 43, 'user', 'Buenardopolis 2', 2),
(12, 46, 'user', 'Buenarda', 5);
...
CREATE TABLE `images` (
  ...
  `alt_text_image` varchar(200) NOT NULL,
...
(57, 'user', '$2y$10$NwfGwxiTXS3Khc8w9zZHOOxAa/cf0PvelvbHDr8nwEjMKE5vb0ztu', 'user@user.com', 1);
...
--
ALTER TABLE `news`
  MODIFY `id_news` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comment_fk_news` FOREIGN KEY (`id_new_fk`) REFERENCES `news` (`id_news`) ON DELETE NO ACTION ON UPDATE NO ACTION;
