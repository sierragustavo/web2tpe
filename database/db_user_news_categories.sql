...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2021 a las 01:18:25
...
INSERT INTO `news` (`title`, `details`, `category_pk`, `author`, `seen`, `id`) VALUES
('hehe', 'asddsadsads', 8, 'prueba1', 0, 28);
...
--
ALTER TABLE `news`
  ADD CONSTRAINT `fk` FOREIGN KEY (`category_pk`) REFERENCES `categories` (`id`);
COMMIT;
